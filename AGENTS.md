...
- **Function/method < 60 lines.** If a function is growing past ~50, extract helpers or split by case (e.g. one small serializer per message role, not one role-dispatch function).
